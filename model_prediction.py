...
train_data = pd.read_csv("D:/KunalProgramming/PYTHON/NLP-Python/digi-diary/static/assets/data_files/tweet_emotions.csv")    
training_sentences = []
...
model = load_model("D:/KunalProgramming/PYTHON/NLP-Python/digi-diary/static/assets/model_file/Tweets_Text_Emotion.h5")
...
#Display entry
def show_entry():
    day_entry_list = pd.read_csv("D:/KunalProgramming/PYTHON/NLP-Python/digi-diary/static/assets/data_files/data_entry.csv")
    ...
    emotion_url_1=day_entry_list["emotion_url"].values[0]
    emotion_url_2=day_entry_list["emotion_url"].values[0]
    emotion_url_3=day_entry_list["emotion_url"].values[0]
